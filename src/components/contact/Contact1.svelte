		...
		<div class="max-w-4xl mx-auto">
			...
			<div class="tb-contact-grid grid grid-cols-1 gap-8">
				...
				<div class="space-y-6">
					...
					{#if data.website}
						<a href={data.website} target="_blank" rel="noopener noreferrer" class="flex items-start space-x-4 p-4 bg-gray-800 rounded-lg hover:bg-gray-700 transition-colors">
							<div class="flex-shrink-0">
								<div class="w-12 h-12 {colors.bg} rounded-lg flex items-center justify-center">
									<svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
							...
							<div>
								...
								<p class="text-lg font-semibold break-all">{data.website}</p>
							</div>
						</a>
					{/if}
					...
					{#if data.social_media}
						<div class="flex items-start space-x-4 p-4 bg-gray-800 rounded-lg">
							...
							<div>
								...
								<p class="text-lg font-semibold">{data.social_media}</p>
							</div>
						</div>
					{/if}
				</div>
